        ...
        <form id="searchForm" :action="formAction" method="get" target="_blank">
            <div class="searchArea">
                ...
                <div class="btnGuoup">
                    ...
                    <el-button type="primary" icon="el-icon-document" @click="downExcel">下载模板</el-button>
                    <div class="importBtn">
                        <el-button type="primary" icon="el-icon-tickets" >导入</el-button>
...
export default {
  ...
  computed: {
    ...
    formAction() {
      ...
      if (window.location.hostname == "localhost") {
        url = "/api/pc/buyer/manage/import/template/download";
      } else {
        url = "/pc/buyer/manage/import/template/download";
      }
      return url;
    }
  },
  methods: {
    ...
    chooseExcel(e) {
        ...
        this.$http.importExcel(data).then(res=>{
            console.log(res)
            let message = (res.message==="")?"":`${res.message}导入失败`
            this.$message({
                showClose: true,
